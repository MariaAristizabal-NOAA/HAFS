...
# NOAA RDHPCS Hera
HOMEhafs=/scratch1/NCEPDEV/hwrf/save/${USER}/hafs_mom6_analysis
...
${PYTHON3} ./run_hafs.py -t ${dev} 2020072806 00L HISTORY ${confopts} # Slot 2: 09L first cycle for Isaias
